...
var fetchTodos = exports.fetchTodos = function fetchTodos() {
  return function (dispatch) {
    (0, _todo_api_util.indexTodos)().then(function (todos) {
      dispatch(receiveTodos(todos));
    });
  };
};

var createTodo = exports.createTodo = function createTodo(params) {
  return function (dispatch) {
    return (0, _todo_api_util.postTodo)(params).then(function (todo) {
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // COMMENT OUT BEFORE PRODUCTION
  window.store = store;
  window.indexTodos = _todo_api_util.indexTodos;
  // COMMENT OUT BEFORE PRODUCTION
...
*/
var aa=__webpack_require__(1),m=__webpack_require__(27),A=__webpack_require__(5),B=__webpack_require__(2),ca=__webpack_require__(28),da=__webpack_require__(29),ea=__webpack_require__(30),ha=__webpack_require__(31),ia=__webpack_require__(32),C=__webpack_require__(8);
...
var todosReducer = function todosReducer() {
  ...
  switch (action.type) {
    case _todo_actions.RECEIVE_TODOS:
      var actionTodos = action.todos;
      actionTodos.forEach(function (todo) {
...
var _id_generator = __webpack_require__(176);
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          this.props.todos.map(function (todo, idx) {
            return _react2.default.createElement(_todo_list_item.TodoListItem, { todo: todo });
          })
        ),
...
var TodoForm = function (_React$Component) {
  ...
  _createClass(TodoForm, [{
    ...
    value: function updateTitle(e) {
      return this.setState(_defineProperty({}, 'title', e.target.value));
    }
  }, {
    key: 'render',
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          null,
          'Title',
          _react2.default.createElement('input', { onChange: this.updateTitle, value: this.state.title })
        ),
        _react2.default.createElement(
          'label',
          null,
          'Body',
          _react2.default.createElement('input', { onChange: this.update('body'), value: this.state.body })
        ),
        _react2.default.createElement(
          'button',
          null,
...
var indexTodos = exports.indexTodos = function indexTodos() {
  return $.ajax({
    method: 'GET',
    url: '/api/todos'
  });
...
var postTodo = exports.postTodo = function postTodo(params) {
  return $.ajax({
    method: 'POST',
    url: '/api/todos',
    data: {
